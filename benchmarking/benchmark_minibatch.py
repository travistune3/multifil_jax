...
Usage:
    python benchmarking/benchmark_minibatch.py [--n N] [--duration_ms D] [--total_runs R]
...
from multifil_jax.simulation import run, get_default_params, BATCH_BUCKETS
...
def main():
    ...
    for M in candidate_sizes:
        ...
        r = run(topo, pCa=4.5, z_line=900.0, duration_ms=duration_ms,
